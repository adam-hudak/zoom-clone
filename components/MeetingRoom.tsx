...
const MeetingRoom = () => {
  ...
  return (
    <section className="h-screen w-full overflow-hidden text-white">
      ...
      <div className="fixed bottom-0 flex w-full items-center justify-center gap-5 flex-wrap px-4">
        <CallControls />
              ...
              <div key={item}>
                <DropdownMenuItem
                  className={cn("cursor-pointer", {
                    "bg-dark-2":
                      item.toLowerCase().replace(" ", "-") === layout,
                  })}
                  onClick={() =>
                    setLayout(
